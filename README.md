...
Agent generated with [`googleCloudPlatform/agent-starter-pack`](https://github.com/GoogleCloudPlatform/agent-starter-pack) version `0.40.0`
...
Edit your agent logic in `agent/agent.py` and test with `make playground` - it auto-reloads on save.
